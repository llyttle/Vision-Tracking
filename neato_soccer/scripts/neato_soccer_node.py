...
class BallTracker(object):
    ...
    def process_image(self, msg):
        ...
        #filter out all of the colors other than red
        self.binary_image = cv2.inRange(self.cv_image, (0,0,1), (10,10,255))

        #create a hue saturation image
    ...
    def run(self):
        ...
        while not rospy.is_shutdown():
            ...
            if not self.hsv_binary_image is None:
